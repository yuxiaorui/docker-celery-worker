...
RUN pip install lxml && pip install pyopenssl && pip install mysql && pip install 'MySQL-python<=1.2.3' && pip install leancloud-sdk && pip install Celery && pip install sqlalchemy && pip install pymongo && pip install pandas
